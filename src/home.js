...
import {FaPython, FaHtml5, FaSass, FaNode} from "react-icons/fa"
...
const Home = (props) => {
  ...
  <div className='homeContainer'>
    ...
    <div className='information'>
      ...
      <h3>{binaryMessage}</h3>
      <p className='intro'>I am an aspiring software developer with an interest in Full Stack Web Development and much more!  </p>
     <div className='iconContainer'>
      ...
      <div><div className='img'><FaNode/></div><p>NodeJS</p></div>
     </div>
    </div>
  </div>
    )
